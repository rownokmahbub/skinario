...
<body>
                ...
                <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul
                        ...
                        <ul
                            ...
                            <li>
                                <a href="doctor.php"
                                    class="block py-2 pl-3 pr-4  bg-cyan-700 rounded md:bg-transparent md:p-0 text-white md:text-cyan-500">Doctor</a>
                            </li>
                            <li>
                                <a href="Rewards.php"
        ...
        <div
            ...
            <div class="z-10">
                <h1
                    ...
                    Our Specialist Doctor <br> Give You Best Advice</h1>
                <p class="mb-8 text-lg font-normal lg:text-xl text-gray-200">our specialized doctor provide you with the
                    best guideline to build your dream skin</p>
            </div>


            <img class="object-contain w-full max-w-xl z-10 min-h-[400px] max-h-[700px]" src="./assets/doctorhero.png"
                alt="">
        </div>
    ...
    <section class="bg-slate-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
        <p class="text-2xl md:text-5xl text-center font-bold mb-10 capitalize">Our Professional Doctor</p>
        <div
            class="container mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 my-20 px-5 md:px-0 gap-6 md:gap-10">
            <div class="w-full max-w-sm border  rounded-lg shadow bg-slate-800 border-gray-700 relative">
                <p class="absolute top-3 right-3 bg-cyan-600 text-white px-4 py-2 rounded-xl">MBBS</p>
                <a class="rounded-lg overflow-hidden" href="#">
                    <img class="p-5 rounded-lg w-full min-h-[450px] max-h-[450px] object-cover"
                        src="./assets/doctor/jebin-removebg-preview.png" alt="product image" />
                </a>
                <div class="px-5 pb-5">
                    <div class="flex flex-col justify-between items-center">

                        <h5 class="text-2xl font-semibold tracking-tight text-white capitalize">Miftahul Jannat jebin
                        </h5>
                        <h5 class="text-md font-normal tracking-tight text-white capitalize">SHahid Suhrawardy Medical
                            College</h5>
                    ...
                    <div class="flex items-center justify-center mt-5">
                        ...
                        <a href="appoinment.php?id=1"
                            class="text-white bg-cyan-700 hover:bg-cyan-800 focus:ring-4 focus:outline-none focus:ring-cyan-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:focus:ring-cyan-800">Make
                            Appointment</a>
                    </div>
                </div>
            </div>
            <div class="w-full max-w-sm border  rounded-lg shadow bg-slate-800 border-gray-700 relative">
                ...
                <a class="rounded-lg overflow-hidden" href="#">
                    <img class="p-5 rounded-lg w-full min-h-[450px] max-h-[450px] object-cover"
                        src="./assets/doctor/Shamima.png" alt="product image" />
                </a>
                <div class="px-5 pb-5">
                    <div class="flex flex-col justify-center items-center">

                        <h5 class="text-2xl font-semibold tracking-tight text-white capitalize">shamima alam</h5>
                        <h5 class="text-md font-normal tracking-tight text-white capitalize">Dhaka Medical College</h5>
            ...
            <div class="w-full max-w-sm border  rounded-lg shadow bg-slate-800 border-gray-700 relative">
                ...
                <a class="rounded-lg overflow-hidden" href="#">
                    <img class="p-5 rounded-lg w-full min-h-[450px] max-h-[450px] object-cover"
                        src="./assets/doctor/wahaj-removebg-preview.png" alt="product image" />
                </a>
                <div class="px-5 pb-5">
                    <div class="flex flex-col justify-between items-center">

                        <h5 class="text-2xl font-semibold tracking-tight text-white capitalize">Wahaj Ali</h5>
                        <h5 class="text-md font-normal tracking-tight text-white capitalize">
                            Dhaka Medical College</h5>
