<?php
include("./dbconf.php");
$query = "SELECT * FROM products WHERE category='medicine'";
...
<body>
                            ...
                            <li>
                                ...
                                <div id="dropdownNavbar"
                                    ...
                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-400"
                                        ...
                                        <li>
                                            <a href="product.php"
                                                class="block px-4 py-2 hover:bg-cyan-100 dark:hover:bg-cyan-600 text-white">Product</a>
                                        </li>

                                        <li>
                                            <a href="medicine.php" class="block px-4 py-2 bg-cyan-400 dark:hover:bg-cyan-600 dark:hover:text-white
                                        text-white">Medicine</a>
                                        </li>
                                    </ul>
        ...
        <div
            ...
            <div class="z-10">
                ...
                <h1
                    ...
                    Our Medicine are <br>based on user needs </h1>
    ...
    <section class="bg-slate-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
        <p class="text-2xl md:text-5xl text-center font-bold mb-10 capitalize">Our skin Care Medicine</p>
