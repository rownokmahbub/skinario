...
<div class="flex bg-slate-800 shadow-2xl rounded-xl flex-col justify-center items-center px-6 py-12 lg:px-8">
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm z-10">
    <form class="space-y-6 flex flex-col justify-center items-center " action="#" method="POST">
        ...
        <div class="mt-2">
          <input id="email" name="name" type="text" required class="block bg-slate-700 w-full rounded-md border-0 py-1.5 text-white  ring-1 ring-inset ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 shadow-xl md:w-[400px]">
        </div>
      </div>
      <div>
    ...
    <p class="mt-10 text-center text-sm text-gray-500">
      Not a member?
      <a href="signup.html" class="font-semibold leading-6 text-indigo-400 hover:text-indigo-500">Sign In</a>
    </p>
  </div>
</div>
</div>
