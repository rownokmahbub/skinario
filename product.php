...
<body>
                        ...
                        <ul
                            ...
                            <li>
                                <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar"
                                    class="flex items-center justify-between w-full py-2 pl-3 pr-4bg-cyan-500 rounded md:bg-transparent md:p-0 text-cyan-500">Services
                                ...
                                <div id="dropdownNavbar"
                                    class="z-10 hidden font-normal  divide-y  rounded-lg shadow w-44 bg-cyan-700 divide-gray-600">
                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-400"
                                        aria-labelledby="dropdownLargeButton">
                                        <li>
                                            <a href="product.php"
                                                class="block px-4 py-2 bg-cyan-400 dark:hover:bg-cyan-600 dark:hover:text-white text-white">Product</a>
                                        </li>

                                        <li>
                                            <a href="medicine.php"
                                                class="block px-4 py-2 hover:bg-cyan-100 dark:hover:bg-cyan-600 text-white">Medicine</a>
                                        </li>
                                    </ul>
    ...
    <section class="bg-slate-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
        <div
            ...
            <img class="object-contain w-full max-w-3xl z-10 " src="./assets/hero.png" alt="">
    ...
    <section class="bg-slate-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
        ...
        <div class="flex items-center gap-3 container mx-auto ">
            <p>Filter</p>
            <select onchange="filterType(this.value)" id="countries"
                class="rounded-xl border  block  p-2 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500 w-96">
                <option value="null" selected>Skin Type</option>
                <option value="oily" <?= $type == 'oily' ? 'selected' : '' ?>>oily</option>
                <option value="combination" <?= $type == 'combination' ? 'selected' : '' ?>>combination</option>
                <option value="dry" <?= $type == 'dry' ? 'selected' : '' ?>>dry</option>
                <option value="acne-prone" <?= $type == 'acne-prone' ? 'selected' : '' ?>>Acne-prone</option>
                <option value="hyper-pigmented" <?= $type == 'hyper-pigmented' ? 'selected' : '' ?>>Hyper-pigmented
                </option>
                <option value="sensitive" <?= $type == 'sensitive' ? 'selected' : '' ?>>sensitive</option>
            ...
            <div class="w-full max-w-sm border rounded-lg shadow bg-slate-800 border-gray-700">
                ...
                <div class="px-5 pb-5">
                    ...
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <input id="quantity<?= $id ?>" name="time" placeholder="Quantity " type="number"
                            autocomplete="email" min="1" value="1" required
    ...
    function addToCart(product_id) {
        ...
        window.location.href = "product.php?id=" + product_id + "&quantity=" + quantity
    }
    </script>
</body>
